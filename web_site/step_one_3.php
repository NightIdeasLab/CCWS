...
<html lang="en">
  <head>
	...
	{
		status("Recording...");
		recording = age + '_' + nationality + '_' + nativeEng + '_' + uuid + '_' + 'step1_audio3.wav';
	...
	var random_images_array1 = ["image1.png", "image2.png", "image3.png"];
...
<body onload="setup()">
    ...
    <div class="recorder container">
	    ...
	    <p style="font-size: 15pt">Carry objects task</p>
	    
	    <center><script type="text/javascript">getRandomImage1(random_images_array1)</script><script type="text/javascript">getRandomImage(random_images_array)</script></center>
		
		<div id="wami"></div>
        <br>
		<p style="font-size: 20pt">Ask the robot to carry the object shown in the first image</p>
		<p style="font-size: 20pt">to the location in the second image.</p>
