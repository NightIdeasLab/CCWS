...
<html lang="en">
  <head>
	...
	{
		status("Recording...");
		recording = age + '_' + nationality + '_' + nativeEng + '_' + uuid + '_' + 'step1_audio2.wav';
...
<body onload="setup()">
    ...
    <div class="recorder container">
	    ...
	    <p style="font-size: 15pt">Follow people task</p>
	    
	    <center><img height="650px" src="img/experiment/follow_people.png" class="img-polaroid"> </center>
	    <br />
		<div id="wami"></div>
        <br>
	    <p style="font-size: 20pt">Ask the robot to follow someone (a generic person, a friend, even yourself).</p>
	    <p style="font-size: 20pt">If you want, specify the speed of the robot (slow/fast/other) as well.</p>
