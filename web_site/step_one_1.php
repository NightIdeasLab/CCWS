...
<html lang="en">
  <head>
	...
	{
		status("Recording...");
		recording = age + '_' + nationality + '_' + nativeEng + '_' + uuid + '_' + 'step1_audio1.wav';
...
<body onload="setup()">
    ...
    <div class="recorder container">
	    ...
	    <p style="font-size: 15pt">Reach a place task</p>
	    	    
	    <center><script type="text/javascript">getRandomImage(random_images_array)</script></center>

	    <div id="wami"></div>
        <br>
	    <p style="font-size: 20pt">Ask the robot to move towards the location provided in the image above.</p>
