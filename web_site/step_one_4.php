...
<html lang="en">
  <head>
	...
	{
		status("Recording...");
		recording = age + '_' + nationality + '_' + nativeEng + '_' + uuid + '_' + 'step1_audio4.wav';
...
<body onload="setup()">
    ...
    <div class="recorder container">
	    ...
	    <p style="font-size: 15pt">Search and check task</p>
	    ...
	    <p style="font-size: 20pt">Ask the robot to search for an object in the location displayed in the picture.</p>
	    <p style="font-size: 20pt">You are free to choose a typical object for this location.</p>
