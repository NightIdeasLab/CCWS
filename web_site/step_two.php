...
<html lang="en">
  <head>
	...
	function record2() {
        ...
        recordingUrl2 = 'http://localhost/web_site/audio/save_file.php?filename=' + recording2;
	...
	function stop2() {
		status("Stop");
		Wami.stopRecording();
		playBackUrl2 = 'http://localhost/web_site/audio/' + recording2;
	...
	function record3() {
        ...
        recordingUrl3 = 'http://localhost/web_site/audio/save_file.php?filename=' + recording3;
	...
	function stop3() {
		status("Stop");
		Wami.stopRecording();
		playBackUrl3 = 'http://localhost/web_site/audio/' + recording3;
	...
	function record4() {
        ...
        recordingUrl4 = 'http://localhost/web_site/audio/save_file.php?filename=' + recording4;
	...
	function stop4() {
		status("Stop");
		Wami.stopRecording();
		playBackUrl4 = 'http://localhost/web_site/audio/' + recording4;
